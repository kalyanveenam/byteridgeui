...
export class HttpService {
  public prod = 'https://interviewbr.herokuapp.com/api/v1';
  ...
  public loguserDetails(username,role,time){
    let header = {};
    header['Authorization'] = localStorage.getItem('authToken');
    header['Content-type'] = 'application/json';
    return this._http.post(
      this.baseUrl + '/users/audits', {
        username: username,
        role: role,
        signintime: time
      }, {
  ...
  public updatelog(auditId, time){
    let header = {};
    header['Authorization'] = localStorage.getItem('authToken');
    header['Content-type'] = 'application/json';
    return this._http.post(
      this.baseUrl + '/update/signout', {
        auditId: auditId,
        signouttime: time
      }, {
        headers: header
  ...
  public getLogs(){
    let header = {};
    header['Content-type'] = 'application/json';
    return this._http.get(this.baseUrl + '/get/logs');
  }
}